...
params:
  raw_tsv:
    ...
    value: "assembly.psitchensis.longranger.wgs.bam.bx.molecule.tsv"
    input: text
  filtered_tsv:
    label: "Input filtered TSV file of read alignments with columns Rname, Start, End, Size, BX, MI, Reads, Mapq_median, AS_median"
    value: "assembly.psitchensis.longranger.wgs.bam.as-30.bx.molecule.tsv"
    input: text
  output_tsv:
    label: "Output TSV file of breakpoints"
    value: "assembly.breakpoints.tsv"
    input: text
---
...
size_threshold <- 500
rname_only <- c("3-7", "9", "18", "25", "4001", "4002", "4003", "4004", "4005", "4006", "4007", "4008")
