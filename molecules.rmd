...
molecules_starts %>% filter(Rname == scaffold_name) %>% ggplot() +
	...
	geom_hline(yintercept = c(depth_good_threshold, starts_threshold), colour = "orange") +
	geom_vline(aes(xintercept = Pos), misassemblies %>% filter(Rname == scaffold_name)) +
