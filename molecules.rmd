...
# Write a list of good barcodes to a TSV file and a text file
```{r good-barcodes}
...
good_barcodes %>% write_tsv("psitchensiscpmt_2.psitchensis.longranger.wgs.bam.as-30.bx.molecule.bx.atleast4.tsv")

good_barcodes %>% select(BX) %>% arrange(BX) %>%
	write_tsv("psitchensiscpmt_2.psitchensis.longranger.wgs.bam.as-30.bx.molecule.bx.atleast4.txt", col_names = FALSE)
```
