...
# Read data
```{r read-data}
counts <- read_tsv("psitchensiscpmt_3.psitchensis.bx.c1_e5000_r0.220000.arcs.dist.tsv") %>%
...
p_values %>%
	...
	write_tsv("psitchensiscpmt_3.psitchensis.bx.c1_e5000_r0.220000.arcs.dist.p.tsv")
```
