...
# Read data
```{r read-data}
bx_filename <- "pglauca.psitchensis.longranger.align.bam.bx.tsv"
bx_count_filename <- "pglauca.psitchensis.longranger.align.bam.bx.count.tsv"
data_all <- read_tsv(filename)
```
